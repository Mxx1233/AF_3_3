 ...
 * @author zx
 * @date 2025-12
 * @version 2.1 - Angepasst an neue API (3-param compute, position-form PI)
 */
...
// ============================================================================
// Test-Gruppe 1: Common Functions (15 Tests)
// ============================================================================
...
// ============================================================================
// Test-Gruppe 2: PI-Regler (22 Tests)
// ============================================================================
...
// ============================================================================
// Test-Gruppe 3: Motor Mapping (12 Tests)
// ============================================================================
...
// ============================================================================
// Test-Gruppe 4: Lateral Controller (17 Tests)
// Note: 3-param compute(y, y_target, phi_k) - no curvature feedforward
// ============================================================================
...
TEST_F(LateralControllerTest, SteeringAngleLimit) {
  ...
  // Output is atan(saturated_input), which is strictly within ±atan(π/6) < ±π/6
...
TEST_F(LateralControllerTest, PDControllerEffect) {
  ...
  EXPECT_LT(delta_high_d, delta_no_d);
}
...
// ============================================================================
// Test-Gruppe 5: Integration Tests (5 Tests)
// ============================================================================
