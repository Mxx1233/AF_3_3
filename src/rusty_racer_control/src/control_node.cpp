...
: Node("control_node")
{
  ...
  const double lat_kp = 0.70;  // Original: 1.5  0.75  0.70  0.65
  const double lat_kd = 0.12;  // Original: 0.3  0.10  0.12  0.12
...
//   // Lateral controller parameters (reduced for low-speed gentle steering)
//   const double lat_kp = 0.75;  // Original: 1.5
//   const double lat_kd = 0.15;  // Original: 0.3
...
//   // Target velocity and lateral offset
//   v_ref_ = 1.0;       // Target velocity [m/s] (Original: 0.8) (best time 1.4)
//   y_target_ = -0.06;  // Target lateral offset [m]
